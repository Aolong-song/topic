...
public class getAdminTopicId {
    @Value("http://${host}:${port}/topicService/admin/topics/{id}")
    String url;
    ...
    @Test
    public void adminDetailRight() throws Exception{
        /* 设置请求头部*/
    ...
    @Test
    public void adminDetailId() throws Exception{
        /* 设置请求头部*/
    ...
    @Test
    public void adminIdNegative() throws Exception{
        /* 设置请求头部*/
