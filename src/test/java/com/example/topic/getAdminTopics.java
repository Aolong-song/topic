...
/**
 * @author 宋澳龙
 * @date 2019/12/18 7:49
 */
@RunWith(SpringRunner.class)
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.RANDOM_PORT)
public class getAdminTopics {
    @Value("http://${host}:${port}/topicService/admin/topics")
    String url;
    ...
    @Test
    public void adminListRight() throws Exception {
...
//        }
    ...
    @Test
    public void adminListPageLimitNegative() throws Exception{
        /* 设置请求头部*/
