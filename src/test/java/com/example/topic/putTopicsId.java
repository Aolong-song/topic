...
public class putTopicsId {
    ...
    public void updateRight()throws Exception{
        ...
        /*assert判断*/
        TopicPo topicPo1 = JacksonUtil.parseObject(body, "data", TopicPo.class);
        assertEquals("https://www.baidu.com/",topicPo1.getPicUrlList());
        assertEquals("百度",topicPo1.getContent());
    }
